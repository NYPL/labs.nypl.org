 ...
 * www/js/lib/jquery.isotope.js
 * www/js/lib/html5.js
 * www/js/lib/modernizr.js
 * www/js/lib/jquery.scrollTo-1.4.3.1.js
 * www/js/responsive-ad.js
 */
window.APP_CONFIG={"REPOSITORY_ALT_URL":null,"SERVER_PROJECT_PATH":"/home/ubuntu/apps/books13","DEPLOY_TO_SERVERS":false,"COPY_GOOGLE_DOC_KEY":"0AqY_LXMyc6rBdDJWblJZMkRFQ28xczF5bkJ5YjZ6anc","DEPLOY_SERVICES":false,"NPR_DFP":{"ENVIRONMENT":"NPR","STORY_ID":"1032","TARGET":"Arts___Life_Books","TESTSERVER":"false"},"PROJECT_DESCRIPTION":"Find your next great read with NPR Books' best-of-2013 reading guide.","PRODUCTION_S3_BUCKETS":["apps.npr.org","apps2.npr.org"],"STAGING_S3_BUCKETS":["stage-apps.npr.org"],"REPOSITORY_NAME":"best-books-2013","PROJECT_NAME":"100 Children's Books","PROJECT_SLUG":"children-100","PRODUCTION_SERVERS":["cron.nprapps.org"],"SERVERS":[],"SERVER_BASE_URL":"http://127.0.0.1:8001/children-100","REPOSITORY_URL":"git@github.com:nprapps/best-books-2013.git","GOOGLE":{"IMAGE_URL":"http://apps.npr.org/children-100/img/preview.png"},"SERVER_VIRTUALENV_PATH":"/home/ubuntu/apps/books13/virtualenv","S3_BASE_URL":"http://127.0.0.1:8000","DEPLOY_CRONTAB":false,"S3_BUCKETS":[],"FACEBOOK":{"URL":"http://apps.npr.org/children-100/","APP_ID":"138837436154588","IMAGE_URL":"http://apps.npr.org/children-100/img/facebook.png","DESCRIPTION":"Find your next great read with our guide to 2013's best books.","TITLE":"NPR's Book Concierge"},"SERVER_PYTHON":"python2.7","DEBUG":true,"STAGING_SERVERS":["50.112.92.131"],"UWSGI_SOCKET_PATH":"/tmp/books13.uwsgi.sock","SERVER_USER":"ubuntu","UWSGI_LOG_PATH":"/var/log/books13.uwsgi.log","DATA_GOOGLE_DOC_KEY":"0AqY_LXMyc6rBdFR2eUtqNHh3NFNmVHhvRjVELXl0bUE","PROJECT_FILENAME":"books13","TWITTER":{"URL":"http://apps.npr.org/children-100/","TEXT":"Find your next great read with NPR's guide to 2013's best books. @nprbooks","IMAGE_URL":"http://apps.npr.org/children-100/img/preview.png"},"SERVER_REPOSITORY_PATH":"/home/ubuntu/apps/books13/repository","SHARE_URL":"http://apps.npr.org/children-100/","APP_LOG_PATH":"/var/log/books13.app.log","SERVER_SERVICES":[["app","/home/ubuntu/apps/books13/repository","ini"],["uwsgi","/etc/init","conf"],["nginx","/etc/nginx/locations-enabled","conf"]],"GOOGLE_ANALYTICS_ID":"","DEPLOYMENT_TARGET":null};
window.COPY={"content":{"purchase":"Purchase","header_subhead":"Heyheyyyy","read_more":"Heyheyyyy","recommended_by":"recommended by","filter_by":"Filter by:","filter_button":"Filter by tags","npr_review_link":"Review:","clear_filters":"Clear Filters","genre":"Genre:","header_title":"100 Children's Books","tag_list":"Filed Under:","chatter":"<p>Use the categories below to search through 100 Children's titles selected by NYPL staff.</p>","npr_author_link":"Author Interview:"},"attribution":{"byline":"byline info"},"tags":{"alternate-reality":"Alternate Reality","family":"Family","ages-6\u20138":"Ages 6\u20138","ages-9\u201312":"Ages 9\u201312","poetry":"Poetry","challenges":"Challenges","fantasy":"Fantasy","colors":"Colors","nonfiction":"Nonfiction","historical-fiction":"Historical Fiction","humor":"Humor","things-that-go":"Things That Go","rhyme-time":"Rhyme Time","girls":"Girls","tearjerkers":"Tearjerkers","true-story":"True Story","sports":"Sports","heroism":"Heroism","nyc":"NYC","picture-books":"Picture Books","mystery":"Mystery","families":"Families","sci-fi":"Sci Fi","nature":"Nature","tales-of-courage":"Tales of Courage","ebook":"eBook","boys":"Boys","adventure":"Adventure","folklore":"Folklore","anthropomorphic":"Anthropomorphic","identity":"Identity","graphic-books":"Graphic Books","school":"School","animals":"Animals","science":"Science","multicultural":"Multicultural","creepy":"Creepy","bedtime":"Bedtime","quests":"Quests","friendship":"Friendship","realism":"Realism","history":"History"}};
...
function AddNamespace(namespacePath){var rootObject=window;var namespaceParts=namespacePath.split('.');for(var i=0;i<namespaceParts.length;i++){var currentPart=namespaceParts[i];if(!rootObject[currentPart])rootObject[currentPart]=new Object();rootObject=rootObject[currentPart];}}AddNamespace('NPR.ServerConstants');NPR.ServerConstants.webHost='apps.npr.org';NPR.ServerConstants.dfpServer='ad.doubleclick.net';NPR.ServerConstants.dfpNetwork='n6735';NPR.ServerConstants.dfpSite='NPR';AddNamespace('NPR.PageInfo');NPR.PageInfo.page={};NPR.PageInfo.page.web_host='http://'+NPR.ServerConstants.webHost;NPR.PageInfo.getUrlParameter=function(pname,pdefault){try{pname=pname.replace(/[\[]/,"\\\[").replace(/[\]]/,"\\\]");var regexS="[\\?&]"+pname+"=([^&#]*)";var regex=new RegExp(regexS);var results=regex.exec(window.location.href);if(results===null)return pdefault;else return results[1];}catch(e){}};AddNamespace('NPR.Devices');if('ontouchstart' in document.documentElement){var winWidth=window.innerWidth;if(winWidth>=768&&winWidth<=1024)$('html').addClass('NPRtablet');if(winWidth<=767)$('html').addClass('NPRphone');}if(NPR.PageInfo.getUrlParameter('device')=='tablet')$('html').addClass('NPRtablet');if(NPR.PageInfo.getUrlParameter('device')=='phone')$('html').addClass('NPRphone');NPR.Devices.isOnTablet=function(){if($('html').hasClass('NPRtablet'))return true;else return false;};NPR.Devices.isOnPhone=function(){if($('html').hasClass('NPRphone'))return true;else return false;};$(document).ready(function(){if(NPR.Devices.isOnTablet())setTimeout(function(){$('div[data-portrait]').each(function(index){var newLocation=$(this).attr('data-portrait');$(this).children().not('script').clone().appendTo('#'+newLocation);});},500);if(window.innerWidth<=1024)$('#main-content').removeClass('col-md-8').addClass('col-md-12');});var DFP={};DFP.tile=0;DFP.ord=Number(window.ord)||Math.floor(Math.random()*1E10);DFP.getParameterFromQueryString=function(strParamName){var strReturn="";var strHref=window.location.href;if(strHref.indexOf("?")>-1){var strQueryString=strHref.substr(strHref.indexOf("?"));var aQueryString=strQueryString.split("&");for(var iParam=0;iParam<aQueryString.length;iParam++)if(aQueryString[iParam].indexOf(strParamName+"=")>-1){var aParam=aQueryString[iParam].split("=");strReturn=aParam[1];break;}}return strReturn;};DFP.queryParameters={sc:DFP.getParameterFromQueryString('sc'),ft:DFP.getParameterFromQueryString('ft')};DFP.renderLocation=function(deviceEnv){if(DFP.shouldRenderForDevice(deviceEnv)){var scValue='';var site=NPR.serverVars.DFPsite;var size='300x250';var sponsorshiptext='<p class="left">NPR thanks our sponsors</p><p class="right"><a href="/about/place/corpsupport/">Become an NPR sponsor</a></p>';if(NPR.Devices.isOnTablet()){size='2048x180';site=NPR.serverVars.DFPmobile;sponsorshiptext='';}else if(NPR.Devices.isOnPhone()){size='640x100';site=NPR.serverVars.DFPmobile;sponsorshiptext='';}if(typeof DFP.queryParameters.sc==='string'&&DFP.queryParameters.sc.length>0)scValue=DFP.queryParameters.sc;else if(typeof document.referrer==='string'&&document.referrer.search('facebook.com')>-1)scValue='fb';else if(typeof DFP.queryParameters.ft==='string')scValue=DFP.queryParameters.ft;var orient='';if(NPR.Devices.isOnPhone()||NPR.Devices.isOnTablet()){if(window.orientation==0||window.orientation==180)orient='portrait';else if(window.orientation==90||window.orientation==-90)orient='landscape';orient='portrait';}DFP.target='http://'+NPR.serverVars.DFPserver+'/adj/'+NPR.serverVars.DFPnetwork+'.'+site+NPR.serverVars.DFPtarget;var toRender='<scr'+'ipt src="'+DFP.target+';sz='+size+';tile='+ (++DFP.tile)+';sc='+scValue+';ord='+DFP.ord+';orient='+orient+';" type="text/javascript" language="javascript"></scr'+'ipt>'+sponsorshiptext;document.write(toRender);if(NPR.Devices.isOnPhone())$(document).ready(function(){$(window).bind('orientationchange',DFP.hideAdsOnOrientationChange);});}};DFP.render88=function(deviceEnv){DFP.target='http://'+NPR.serverVars.DFPserver+'/adj/'+NPR.serverVars.DFPnetwork+'.'+NPR.serverVars.DFPsite+NPR.serverVars.DFPtarget;var toRender='<scr'+'ipt src="'+DFP.target+';sz=88x31'+';tile='+ (++DFP.tile)+';ord='+DFP.ord+';" type="text/javascript" language="javascript"></scr'+'ipt>';document.write(toRender);};DFP.hideAdsOnOrientationChange=function(){if(window.orientation==90||window.orientation==-90)$('#adhesion').remove();};DFP.shouldRenderForDevice=function(deviceEnv){if(!deviceEnv)return false;else{var shouldRender=false;var winWidth=$(window).width();var winOrientation=window.orientation;switch(deviceEnv){case 'desktop':var ieEightCheck=($.browser.msie===true&&($.browser.version==='7.0'||$.browser.version==='8.0'));if(ieEightCheck)shouldRender=true;else if(!NPR.Devices.isOnTablet()&&winWidth>1024)shouldRender=true;break;case 'mobile':if((NPR.Devices.isOnPhone()||NPR.Devices.isOnTablet())&&winWidth>=300&&winWidth<=1024)if(winWidth>=480||winOrientation==0||winOrientation==180)shouldRender=true;break;default:break;}return shouldRender;}};DFP.setCookieVal=function(){var date=new Date();date.setTime(date.getTime()+(60*1000));var expires="; expires="+date.toGMTString();document.cookie="sponsorcap=true"+expires+"; path=/";};var googletag=googletag||{};googletag.cmd=googletag.cmd||[];(function(){var gads=document.createElement('script');gads.async=true;gads.type='text/javascript';var useSSL='https:'==document.location.protocol;gads.src=(useSSL?'https:':'http:')+'//www.googletagservices.com/tag/js/gpt.js';var node=document.getElementsByTagName('script')[0];node.parentNode.insertBefore(gads,node);})();